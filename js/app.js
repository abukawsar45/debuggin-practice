...
const showProducts = (products) => {
   ...
   /* 
   nicher line ta buji nai
   */
   // const allProducts = products.slice(0, 9).map((pd) => pd);
...
const addToCart = (id, price) => {
   ...
   // // const updatePrice2 = updatePrice(, price);
   // console.log(id)
